...
The first exports the pathway's full 2-hop neighborhood. The second keeps at most 50 second-hop relationships per gene, chosen in a fixed order so the export is the same every time. The third reproduces the biased export from Finding 1.
